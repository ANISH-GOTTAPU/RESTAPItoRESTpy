...
sys.path.insert(0, "C:/Keysight/RestPy_Migration/GIT_Repo/ReadyToCommit/RESTAPItoRESTpy/Modules")
...
if osPlatform in ['windows', 'windowsConnectionMgr']:
    mainObj = Connect(apiServerIp='localhost',
                      serverIpPort='11009',
                      serverOs=osPlatform,
                      deleteSessionAfterTest=deleteSessionAfterTest,
                      generateLogFile='ixiaDebug.log'
